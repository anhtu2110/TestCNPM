            ...
            <div class="col-md-9">
                ...
                <div class="row shadow pb-2 wow fadeInUp">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="btn_delete d-flex justify-content-end mb-1">
                            <button type="button" class="btn btn-sm btn-primary huydon"
                                data-status-id="<?php echo $item['status'];?>"
                                data-order-id="<?php echo $item["OrderID"] ?>">Thay đổi địa chỉ</button>
                        </div>
                        <div class="btn_delete d-flex justify-content-end">
                            <button type="button" class="btn btn-sm btn-danger huydon"
                                ...
                                data-status-id="<?php echo $item['status'];?>"
                                data-order-id="<?php echo $item["OrderID"] ?>">Hủy đơn</button>
                        </div>
                    </div>
