      ...
      <div class="container">
        ...
        <div class="allProduct ">
          ...
          <div class="col-md-2 wow fadeInUp ">
            ...
            <a href="details.php?Product_Detail_id=<?php echo $ProductItem['IDDetail'];?>" class="p-0" style="font-size:14px;">Xem chi tiết sản phẩm...</a>
            <div class="giathanh d-flex justify-content-between">
              <p class="product-price"><?php echo number_format($ProductItem['Price'], 0, '.', '.');?> VND</p>
              <p class="product-cost"><?php echo number_format($ProductItem['OldPrice'], 0, '.', '.');?> VND</p>
          </div>
          </div>
          <?php
          $count++;
