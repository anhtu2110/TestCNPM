    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="sll d-flex">
                <p>Số lượng :</p>
                <button class="btn btn-outline-primary decrement"
                    data-id-product="<?php echo $item['ProductID'] ?>">-</button>
                <input type="text" value="<?php echo isset($item['Quantity']) ? $item['Quantity'] : 1;?>" min='1'
                    class="quantity">
                <button class="btn btn-outline-primary increment"
                    data-id-product="<?php echo $item['ProductID'] ?>">+</button>
            </div>
...
$(document).ready(function() {
    $(".decrement").click(function(e) {
        e.preventDefault();
        alert($(this).next("input.quantity").val());
        var product_id = $(selector).attr("data-id-product");
        alert("Product_id : " + product_id);

    });
    $(".increment").click(function(e) {
        e.preventDefault();
        alert($(this).prev("input.quantity").val());
    });
});
</script>