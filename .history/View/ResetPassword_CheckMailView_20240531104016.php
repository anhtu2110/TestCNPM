    ...
    <form action="">
        <div class="mt-3">
            ...
            <div class="username d-flex mt-3">
                ...
                <input type="text" id="verification_code" name="verification_code" class="no-border" placeholder="Nhập mã có trong Email..." required>
            </div>
            <hr>
        </div>
...
<script>
    ...
    document.getElementById('change_password').addEventListener('click', (e) => {
        ...
        document.getElementById('change_password').innerHTML = '<div class="sniper d-flex"><span class="spinner-grow spinner-grow-sm p-1"></span><span class="spinner-grow spinner-grow-sm p-1"></span><span class="spinner-grow spinner-grow-sm p-1"></span></div>';
        setTimeout(() => {
    ...
    document.getElementById('update_password').addEventListener('click', (e) => {
        ...
        xhr.open('POST', './Controller/Check_CodePasswordController.php', true);
        xhr.onload = function() {
            if (xhr.status === 200) {
                try {
