...
document.getElementById('change_password').addEventListener('click', (e) => {
    ...
    fetch('http://192.168.126.128:80/TestCNPM/Controller/ResetPasswordController.php', {
            method: 'POST',
            body: formData
        })
...
document.getElementById('update_password').addEventListener('click', (e) => {
    ...
    xhr.open('POST', 'http://192.168.126.128:80/TestCNPM/Controller/Check_CodePasswordController.php',
        true);
    xhr.onload = function() {
        if (xhr.status === 200) {
            try {
