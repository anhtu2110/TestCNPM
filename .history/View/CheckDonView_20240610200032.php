<?php
    require_once $_SERVER['DOCUMENT_ROOT'].'/Controller/CheckDonController.php';
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="row shadow pb-2 wow fadeInUp">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="giatienhientai d-flex">
                            <p class="mb-0">Giá : <span class="mb-0"><?php echo number_format($item['Price'],0,'.','.');?>VND</span></p>
                        </div>
            ...
            padding: 0.2em 0.4em;
                            ...
                            <?php
                                switch($item['status']){
                                    ...
                                    case 5:
                                        ...
                                        break; 
                                    case 6: 
                                        $check = "<span class='badge bg-primary'>abc</span>";
                                        break;     
                                }
                            ?>
                    ...
                    data-delete-id="<?php echo $item['ProductID'];?>" data-status-id="<?php echo $item['status'];?>">Hủy đơn</button>
                </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 my-auto ">
                <button type="button" class="btn btn-outline-danger wow zoomIn " id="thaydoidiachi">Thay Đổi Địa Chỉ</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('thaydoidiachi').addEventListener('click',()=>{
    ...
    document.querySelectorAll('.huydon').forEach(btn =>{
        btn.addEventListener('click',(e)=>{
            ...
            xhr.open('POST','./Controller/CheckDonController.php',true);
            xhr.onload = ()=>{
                if(xhr.status === 200){
