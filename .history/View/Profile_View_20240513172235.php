...
<?php require_once './Controller/Profile_Controller.php';
        ...
        <form>
            ...
            <div class="row">
                <div class="form-group col-md-6" style="height: auto;">
                    ...
                    <div class="form_password d-flex">
                        <input type="password" class="form-control m-0" value="<?php echo $row['Password'];?>" id="Password" style="height: 41.6px;" name="password">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="tel" class="form-control" id="phone_number" value="<?php echo $row['Phone_Number'];?>" name="phone_number">
                </div>
