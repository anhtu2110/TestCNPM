<?php
    ...
    class CheckOut_controller{
        ...
        public function Update_Inforamation_With_OrderID($OrderID, $UserID, $Information) {
            return $this->model->Update_Inforamation_With_OrderID($OrderID, $UserID ,$Information);
        }
    }
    ...
    if(isset($_POST['provinceId'])){
        ...
        if(isset($_POST['OrderID'])) {
            ...
            $result = $controller->Update_Inforamation_With_OrderID($OrderID, $_POST['UserID'], $Information);
        } else {
