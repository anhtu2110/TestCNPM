...
document.getElementById('btn_information').addEventListener('click', (e) => {
    ...
    if (provinceElement.selectedOptions.length === 0 || districtElement.selectedOptions.length === 0 || wardElement.selectedOptions.length === 0) {
    ...
    let information = `Họ và tên: ${name} \n Email: ${email} \n Địa chỉ: ${ward} - ${district} - ${province} \n Số điện thoại: ${phone}`;
