    ...
    <div class="container-fluid" style="background-color: white;padding-bottom:7px;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto">
                ...
                ?>
                <li class="nav-item <?php echo !empty($menuItem['dropdown']) ? 'dropdown' : ''; ?>" id="<?php echo isset($menuItem['MenuID']) ? $menuItem['MenuID'] : ''; ?>">
                    <a class="nav-link <?php echo !empty($menuItem['dropdown']) ? 'dropdown-toggle' : ''; ?>" href="<?php echo isset($menuItem['Link']) ? $menuItem['Link'] : '#'; ?>" <?php echo !empty($menuItem['dropdown']) ? 'data-bs-toggle="dropdown"' : ''; ?>>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo isset($dropdownItem['#newproduct']) ? $dropdownItem['#newproduct'] : '#newproduct'; ?>">
            ...
            <ul class="navbar-nav ms-auto d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="profile.php?profile_id=<?php echo $_SESSION['userID']; ?>">
