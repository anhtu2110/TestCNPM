        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <?php
                  ...
                  $total_prices_not_null = $controller->Get_Total_Price_Product_Status_Not_Null_Controller($_SESSION['userID']);
                ?>
            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="btncheckout text-center">
                            <div class="d-gird ">
                                ...
                                <p class="m-0">OR</p>
                                <button class="btn btn-light w-100" onclick="window.location.href='checkdon.php'" <?php if ($total_prices_not_null <= 0) {
                                        echo "disabled";
                                    } ?>>Xem lộ
                                    trình đơn hàng <?php echo $total_prices_not_null; ?></button>
                            </div>
                        </div>
                    </div>
                </div>
