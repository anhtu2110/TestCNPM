                ...
                <div class="cart-checkout d-flex justify-content-center align-items-center">
                    <div class="container">
                        ...
                        <div class="btncheckout text-center">
                          <div class="d-gird ">
                              <button class="btn btn-primary w-100 mt-2"onclick="window.location.href='checkout.php'">Check Out</button>
                              <p class="m-0">OR</p>
                              <button class="btn btn-light w-100"onclick="window.location.href='checkdon.php'">Xem lộ trình đơn hàng</button>
                          </div>
                      </div>
                    </div>
                </div>
