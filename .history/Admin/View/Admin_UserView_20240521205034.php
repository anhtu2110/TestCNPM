<div class="row d-flex mb-3">
    ...
    <button class="btn btn-info mt-4" id="export_staff" style="margin-right: 5px;;"><i class="fa-regular fa-file-excel"></i> Xuất Excel</button>
...
<table class="mx-auto table table-bordered">
    ...
    ?>
        ...
        <tr>
            ...
            <td style="padding:5px;"><img src="<?php echo $bien['Image']; ?>" alt=""style="max-width: 80px;max-height: 80px;"></td>
            ...
            <td style="padding:5px">
                <div class="chucnang d-flex">
                    <div class="btn_update mx-auto">
                        <button type="button" class="btn btn-primary btn-sm edit_user" style="margin-left: 6px;margin-top:5px;">
                        <a href="update_staff.php?update_staff=<?php echo $bien['UserID'];?>"><i class="fa-solid fa-pen"style="color:white;"></i></a></button>
                        <button type="button" class="btn btn-danger btn-sm delete_user" style="margin-left: 6px; margin-top:5px;" 
                        data-user-id="<?php echo $bien['UserID'];?>"><i class="fa-solid fa-trash-can"></i></a></button>
                    </div>
                </div>
            </td>
        </tr>
