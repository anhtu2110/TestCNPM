        ...
        <td>
            <div class="chucnang d-flex">
                <div class="btn_update mx-auto">
                    ...
                    <button type="button" class="btn btn-danger btn-sm detele_order"
                        data-order-id='<?php echo $item['OrderID'];?>' style="margin-left: 6px;margin-top:5px;">
                        <i class="fa-solid fa-trash-can"></i></button>
                    <button type="button" class="btn btn-warning btn-sm" style="margin-left: 6px;margin-top:5px;"
                        data-bs-toggle="tooltip" title="Xuất hóa đơn đỏ">
                        <a href="export_invoice.php?id_order=<?php echo $item['OrderID'];?>" style='color:white;'>
                            <i class="fa-solid fa-file-invoice"></i></a></button>
                </div>
            </div>
        </td>
    </tr>
