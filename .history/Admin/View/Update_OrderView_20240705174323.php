...
$list_status_order = $controller->Get_list_status_order()->fetch_assoc();
print_r($list_status_order);
?>
<form action="">
        ...
        <div class="col-6">
            ...
            <select class="form-control" id="status" name="Title">
                ...
                foreach ($list_status_order as $value) {
                    ?>
                <option value="<?php $value['id_status'] ?>"><?php echo $value['name_status'] ?></option>
                <?php
                }
                ?>
