    ...
    <div class="row d-flex mb-3">
        ...
        <div class="col-4 d-flex justify-content-end">
            <button class="btn btn-info mt-4" id="export_customer" style="margin-right: 5px;;"><i class="fa-regular fa-file-excel"></i> Xuất Excel</button>
            <button class="btn btn-success mt-4" id="chuyen_add_customer"><i class="fa-solid fa-check"></i> Thêm Khách hàng
                mới</button>
        </div>
    </div>
                    ...
                    <div class="chucnang d-flex">
                        <div class="btn_update mx-auto">
                            <button type="button" class="btn btn-primary btn-sm" style="margin-left: 6px;margin-top:5px;">
                                <a href="update_customer.php?customer_id=<?php echo $item['UserID']; ?>" style="color:white;"><i class="fa-solid fa-pen"></i></a>
                            </button>
                            <button type="button" class="btn btn-danger btn-sm delete_customer" data-customer-id="<?php echo $item['UserID']; ?>" style="margin-left: 6px;margin-top:5px;"><i class="fa-solid fa-trash-can"></i></button>
                        </div>
                    </div>
                </td>
            <?php
