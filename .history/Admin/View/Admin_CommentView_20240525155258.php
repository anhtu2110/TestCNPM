<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/Admin/Controller/Admin_CommentController.php';
$limit = 4;
            ...
            <td>
                <div class="chucnang d-flex">
                    <div class="btn_update mx-auto">
                        ...
                        <button type="button" data-delete-id='<?php echo $items['CmtID']; ?>'
                         id='delete_comment' class="btn btn-danger btn-sm" style="margin-left: 6px;margin-top:5px;"
                          data-bs-toggle="tooltip" title="Xóa!" style="margin-left: 6px;"><i class="fa-solid fa-xmark"></i></button>
                    </div>
                </div>
            </td>
        </tr>
