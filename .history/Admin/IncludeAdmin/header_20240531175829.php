	...
	<div class="wrapper">
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Đăng xuất</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="admin_blog.php">
							<i class="fa-solid fa-signs-post"></i></i> <span class="align-middle">Quản lý bài viết</span>
            </a>
					</li>
					...
					<li class="sidebar-item">
						...
						<i class="fa-regular fa-comment-dots"></i></i> <span class="align-middle">Quản lý Comment</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="<?php echo $_SESSION['Image'] ? $_SESSION['Image'] : './img/avt.png';?>"class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><?php echo $_SESSION['UserName'] ? $_SESSION['UserName'] : 'Username';?></span>
              </a>
