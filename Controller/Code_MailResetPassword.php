<?php
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/MyHouseDecorAdmin/vendor/PHPMailer-master/src/SMTP.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/MyHouseDecorAdmin/vendor/PHPMailer-master/src/Exception.php';
